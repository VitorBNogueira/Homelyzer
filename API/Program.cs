...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        builder.Services.AddAutoMapper(typeof(APIAssemblyEntryPoint).Assembly); // fetches everything to do with AutoMapper in the assembly where the class resides (in this case, API)
